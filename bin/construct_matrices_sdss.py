...
if gal_type=='qso_BL':
	...
	)&(cat['CLASS']=='QSO')&(cat['SN_MEDIAN_ALL']>SN_threshold)
...
if gal_type=='X_no_BL':
	...
	(cat['SOURCETYPE']=='TDSS_FES_HYPQSO' )	)&(cat['SUBCLASS']!='BROADLINE')&(cat['SUBCLASS']!='STARFORMING BROADLINE')&(cat['SUBCLASS']!='STARBURST BROADLINE')&(cat['SN_MEDIAN_ALL']>SN_threshold)
	print(len(cat['Z'][ok_i]))
	print(n.histogram(cat['Z'][ok_i],bins=n.arange(0,3.1,0.5)))
...
if gal_type=='GAL_agn_all':
	...
	)&(cat['CLASS']=='GALAXY')&(cat['SN_MEDIAN_ALL']>SN_threshold)
	print(len(cat['Z'][ok_i]))
	print(n.histogram(cat['Z'][ok_i],bins=n.arange(0,3.1,0.5)))
...
if gal_type == "XAGN":
	...
	ok_i=(cat['ZWARNING']==0)&(cat['Z']>zmin)&(cat['Z']<=zmax)&(
	  ...
	  (cat['SOURCETYPE']=='S82X_TILE1')|
	  (cat['SOURCETYPE']=='S82X_TILE2')
	  )&(cat['SN_MEDIAN_ALL']>SN_threshold)
	print(len(cat['Z'][ok_i]))
	print(n.histogram(cat['Z'][ok_i],bins=n.arange(0,3.1,0.5)))
...
if gal_type == "QSO":
	...
	ok_i=(cat['ZWARNING']==0)&(cat['Z']>zmin)&(cat['Z']<=zmax)&(
	  ...
	  (cat['SOURCETYPE']=='RADIO_2LOBE_QSO')|
	  (cat['SOURCETYPE']=='WISE_BOSS_QSO')|
	  (cat['SOURCETYPE']=='TDSS_FES_HYPQSO' ) )&(cat['SN_MEDIAN_ALL']>SN_threshold)
	print(len(cat['Z'][ok_i]))
	print(n.histogram(cat['Z'][ok_i],bins=n.arange(0,3.1,0.5)))
...
if gal_type == "ELG":
	...
	zQ_min = 2.
	ok_i=(cat['Z_ZQ']>=zQ_min)&(cat['Z']>zmin)&(cat['Z']<=zmax)&(cat['SN_MEDIAN_ALL']>SN_threshold)
	print(len(cat['Z'][ok_i]))
	print(n.histogram(cat['Z'][ok_i],bins=n.arange(0,3.1,0.5)))
