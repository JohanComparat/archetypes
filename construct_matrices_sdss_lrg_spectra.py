...
ok_i=(cat['ZWARNING']==0)&(cat['Z']>zmin)&(cat['Z']<=zmax)&((cat['SOURCETYPE']=='LRG')|(cat['SOURCETYPE']=='FAINT_HIZ_LRG')|(cat['SOURCETYPE']=='HIZ_LRG')|(cat['SOURCETYPE']=='LRG_ROUND3'))
...
name = "ebossLRG_zmin_"+str(zmin)+"_zmax_"+str(zmax)+"_Ngal_"+str(nGal)
print("run name:",name)
